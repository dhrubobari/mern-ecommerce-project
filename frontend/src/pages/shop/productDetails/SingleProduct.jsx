        ...
        <div className="flex flex-col items-center md:flex-row gap-8">
          ...
          <div className="md:w-1/2 w-full">
            ...
            <p className="text-gray-400 mb-4">
              This is a product description. It provides details about the
            ...
            <button className="mt-6 px-6 py-2 rounded bg-red-600 text-white font-semibold hover:bg-red-700 transition">
              Add to Cart
            </button>
          </div>
        </div>
